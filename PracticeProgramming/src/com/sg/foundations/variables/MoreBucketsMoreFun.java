...
public class MoreBucketsMoreFun {
	public static void main(String[] args) {
        ...
        butterflies--;
        // The operator we are using to show that the dog ate a bug is -- (decrement)
        // The number of bugs did not change when we change the number of butterflies because we did not change the bugs variable
